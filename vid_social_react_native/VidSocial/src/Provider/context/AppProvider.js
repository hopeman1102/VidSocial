  ...
  NetInfo.fetch().then(state => {
   if(state.isConnected==true)
    ...
    <AppContext.Provider
        value={{...funcs}}
        >
    <SafeAreaView style={{flex:1,backgroundColor:'#FF87A4'}}>
    {/* <SafeAreaView style={{flex:1,backgroundColor:global.UserType== 1 ? Colors.girlbackgroundcolor : Colors.boybackgroundcolor}}> */}
        <StatusBar
               hidden = {false}
               StatusBarStyle='dark-content'
              //  backgroundColor = {global.UserType== 1 ? Colors.girlbackgroundcolor : Colors.boybackgroundcolor}
               backgroundColor = { '#FF87A4' }
               translucent = {false}
